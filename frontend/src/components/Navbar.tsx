...
const Navbar = () => {
  return (
    <>
      <div className="w-[100vw] border-b-[2px] bg-transparent border-b-black z-10 py-[1rem] flex items-center justify-center sticky top-0">
        ...
        <div className="w-full px-[1rem] md:px-0 md:w-[65%] flex items-center justify-between">
          ...
          <div className="flex items-center gap-[1.5rem]">
            ...
            <div>
              <ParentButton label="Get Started" textSize="text-sm" width="w-full" />
            </div>
          </div>
        </div>
      </div>
